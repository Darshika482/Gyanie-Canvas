         ...
         <div className="w-72 shrink-0 flex flex-col gap-4" onMouseDown={(e) => e.stopPropagation()}>
            <div className="bg-white rounded-xl border border-neutral-200 overflow-hidden">
              ...
              <div className="p-4 border-b border-neutral-100">
                <h3 className="font-extrabold text-sm text-neutral-900">Module {system.modules.length + 1}: Final Thoughts</h3>
                <div className="flex items-center gap-3 text-[10px] font-bold text-neutral-400 uppercase tracking-tighter mt-1">
                  <span>0 Tasks</span>
                  <span className="w-1 h-1 rounded-full bg-neutral-300"></span>
                  <span>0 Mins</span>
                </div>
              ...
              <div className="p-6 flex flex-col items-center text-center">
                <div className="w-16 h-16 border-2 border-dashed border-neutral-200 rounded-2xl flex items-center justify-center text-neutral-300 mb-3 hover:border-amber-300 hover:text-amber-500 transition-colors cursor-pointer">
                  <Plus className="w-8 h-8" strokeWidth={2} />
                </div>
                <p className="text-xs text-neutral-400 font-medium px-4">Drag a resource here to create a task</p>
              </div>
            </div>
         </div>
      </div>
