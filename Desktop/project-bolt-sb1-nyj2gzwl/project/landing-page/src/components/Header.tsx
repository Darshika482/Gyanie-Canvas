            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex items-center justify-between h-16">
                    ...
                    <div className="hidden md:flex items-center space-x-4">
                        ...
                        <button className="bg-gradient-to-r from-teal-500 to-cyan-600 text-white px-6 py-2 rounded-lg font-semibold hover:scale-105 transition-transform duration-200">
                            Get Started
                        </button>
                    </div>
                    ...
                    <div className="md:hidden absolute top-16 left-0 right-0 bg-white border-t shadow-lg">
                        <nav className="px-4 py-4 space-y-4">
                            ...
                            <div className="pt-4 border-t space-y-2">
                                ...
                                <button className="w-full bg-gradient-to-r from-teal-500 to-cyan-600 text-white px-6 py-2 rounded-lg font-semibold">
                                    Get Started
                                </button>
                            </div>
                        </nav>
