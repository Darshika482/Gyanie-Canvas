...
export default function CollectionStation() {
  ...
  const { addTransaction, currentDay, currentSlot, addPoints } = useTransactionStore();
      ...
      <div className="flex-1 overflow-auto p-4 max-w-4xl mx-auto w-full md:grid md:grid-cols-2 md:gap-6 md:items-start">
        ...
        {!selectedStudent && (
          <div className="mb-4">
            ...
            <div className="card text-center py-4 mb-3 border-2 border-dashed border-gray-300">
